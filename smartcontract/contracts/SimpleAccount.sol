...
contract SimpleAccount is BaseAccount, TokenCallbackHandler, UUPSUpgradeable, Initializable {
    ...
    address aUSDCTokenAddres = 0x4086fabeE92a080002eeBA1220B9025a27a40A49;
    ...
    function withdrawAToken(address token, uint256 amount) public {
        // _requireFromEntryPointOrOwner(); 
        IPool(aavePoolAddress).withdraw(token, amount, address(this));
    }

    function transferATokenSavingAccountTo(uint256 amount, address recipient) public {
        // _requireFromEntryPointOrOwner(); 
        IERC20(aUSDCTokenAddres).approve(recipient, amount);
        IERC20(aUSDCTokenAddres).transfer(recipient, amount);
    }
    ...
    // TODO: implement this function to invest to pendle fixed yield
