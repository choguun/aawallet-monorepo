...
import LogoKleva from '@/assets/logos/kleva_logo.svg';
            ...
            <div className="p-6">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="flex items-center">
                        <small className="mx-auto mt-2">integrated with <a href="https://kleva.io/" target='_blank'>Kleva <Image className="inline-block" width={12} src={LogoKleva} alt="" /></a></small>
                    </div>
                </div>
            </div>
        </div>
