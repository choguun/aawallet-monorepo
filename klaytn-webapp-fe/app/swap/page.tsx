...
import LogoKlayswap from '@/assets/logos/klayswap_logo.svg';
...
<select className="w-full p-1" value={token2} onChange={(e) => setToken2(e.target.value)}>
      ...
      >
        ...
        <div className="flex items-center">
            <small className="mx-auto mt-2">integrated with <a href="https://klayswap.com/exchange/swap" target='_blank'>Klayswap <Image className="inline-block" width={20} src={LogoKlayswap} alt="" /></a></small>
        </div>
